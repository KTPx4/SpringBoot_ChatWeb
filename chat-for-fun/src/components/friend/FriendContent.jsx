...
const FriendContent = ({userId, openModal, messageApi})=>{
    ...
    return(
        <>
            ...
            >
                ...
                <ListFriend searchName={searchValue} currentUser={currentUser} clickUser={clickUser} afterLoad={handleAfterLoad} updateUser={updateUser}/>
